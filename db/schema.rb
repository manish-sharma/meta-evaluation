...
ActiveRecord::Schema.define(version: 20180326071921) do
  ...
  create_table "evaluation_component_term_stage_details", force: :cascade do |t|
    ...
    t.index ["evaluation_stage_id", "evaluation_component_id", "organization_id", "deleted_at"], name: "uniqueness_index_for_ectsd", unique: true
  ...
  create_table "evaluation_components", force: :cascade do |t|
    ...
    t.index ["name", "organization_id", "deleted_at"], name: "uniqueness_index_for_evaluation_component"
  ...
  create_table "evaluation_schemes", force: :cascade do |t|
    ...
    t.index ["name", "organization_id", "deleted_at"], name: "evaluation_scheme_uniqueness_index", unique: true
