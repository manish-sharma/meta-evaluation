class CreateEvaluationComponentTermStageDetails < ActiveRecord::Migration[5.1]
  def change
    ...
    add_index :evaluation_component_term_stage_details, [:evaluation_stage_id,:evaluation_component_id,:organization_id,:deleted_at],unique: true, name: "uniqueness_index_for_ectsd"
  end
end
